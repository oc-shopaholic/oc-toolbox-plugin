<?php return [
    ...
    'message' => [
        'create_success'                    => 'Success: Name was created',
        'update_success'                    => 'Success: Name was edited',
        'delete_success'                    => 'Success: name was deleted',
        'restore_confirm'                   => 'Are you sure you want to restore the selected items?',
        'restore_success'                   => 'Items recovered',
    ],
    'settings' => [
        'count_per_page' => 'Number of items per page',
        'number_validation' => 'You must enter the number of items',
